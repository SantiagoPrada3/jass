...
// Información básica del administrador que viene del backend
...
// Admin completo (para compatibilidad con código existente)
...
export interface createRequestParameter {
  organizationId: string;
...
export interface updateRequestParameter {
  organizationId?: string;
  parameterName?: string;
  parameterValue?: string;
  parameterDescription?: string;
...
export interface updateRequestTarifa {
  zoneId?: string;
  fareName?: string;
  fareAmount?: string;
...
export interface createRequestTarifa {
  zoneId: string;
  fareName: string;
  fareAmount: string;
  fareDescription: string;
